...
<%
	if(request.getAttribute("ppList")==null || request.getAttribute("ppList").equals("")){
...
<div class="banner"><a href="###"><img src="images/index/banner.jpg" width="1200" height="60" /></a></div>
...
<div class="nav">
	<div class="navCon">
    	<span class="allClass f_l"><i title="全部商品分类">全部商品分类</i></span>
        <ul class="f_l">
         ...
         <span class="collectRemind f_l" id="collectionManage"><i id="collectionManageSub">收藏提醒</i></span>
          <div class="menu" id="menu2">
            ...
            <div class="menuArea2" id="menuArea6">
                <h3>生活百货</h3>
        ...
        <div class="menuClass" id="menuClass1" style="display:none;">
        	<span class="menuBrand f_r">
            <h3>热门品牌</h3>
...
<div class="screen">
	<div class="navHover f_l"><img src="images/index/navHover.png" width="179" height="482" /></div>
    <div class="bbt f_l">
    	<div class="bannerPPT"><iframe src="implant/bannerPPT.html" width="771" height="245"  scrolling="no" frameborder="0"></iframe></div>
        <div class="timePPT"><iframe src="timePPT" width="771" height="223" scrolling="no" frameborder="0" style="margin-top:10px;"></iframe></div>
    </div>
    <div class="switch f_l">
    	<div class="switchImg1"><img src="images/index/switchImg1.jpg" width="230" height="245" /></div>
        <div class="switchImg2"><img src="images/index/switchImg2.jpg" width="230" height="218" /></div>
    </div>
</div>

<div class="hot">
	<div class="hotArea f_l">
    	<div class="hotAreaText">
        	<i class="f_r">热卖促销商品，不容错过，更多惊喜等你发现</i>
            <h3 class="f_l">热卖区</h3>
            <a class="f_l" id="change">换一批</a>
        </div>
        <div class="hotAreaGoods" id="changeHover1">
        	<c:forEach var="item" items="${pList}" varStatus="i">
            <c:if test="${i.index <4}" >  
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}" width="180" height="135"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}" /></a></dt>
                <dd>
                	<p><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}">${fn:substring(item.introduce,0,46)}</a></p>
                    <i class="f_l">¥${item.price }</i>
                    <input type="button" value="抢购" onclick="javascript:saveSql(${item.products_id },2,1);" class="f_r" />
                </dd>
                <img src="images/share/index/${item.status_img }" width="52" height="52" class="style" title="${item.status_content }" />
            </dl>
            </c:if>
            </c:forEach>
        </div>
        <div class="hotAreaGoods" style="display:none" id="changeHover2">
        ...
        <div class="hotAreaGoods" style="display:none" id="changeHover3">
    ...
    <div class="hotSidebar f_r">
    	<div class="phoneMoney">
        	<form action="###" method="get">
        		<h3>手机充值</h3>
            	<p>手机号&nbsp;<input type="text" class="number" /></p>
            	<p>面&nbsp;&nbsp;值&nbsp;<input type="text" class="money" />&nbsp;&nbsp;<i>100.00</i></p>
            	<input type="submit" value="立即充值" class="topUp" />
            </form>
        </div>
        <div class="hotSwitch"><img src="images/index/hotSwitch.jpg" width="230" height="120" /></div>
    </div>
</div>

<div class="good">
	<div class="goodText">
    	<i class="f_r">热门好评商品，不要错过哦</i>
        <h3>好评热品</h3>
    </div>
    <div class="goodGoods">
    	<iframe src="goodGoods" width="1200" height="277" scrolling="no" frameborder="0"></iframe>
	</div>
</div>

<div class="recommended">
	<div class="recommendedPPT f_l">
    	<div class="rPTop">
        	<h3 class="f_l" id="rPTop1">您也许感兴趣</h3>
            <h3 class="f_l" id="rPTop2">新品发布</h3>
            <h3 class="f_l" id="rPTop3">发烧好评</h3>
            <h3 class="f_l rPTopOlone" id="rPTop4"><a href="###">狠惠配</a></h3>
        </div>
        <div class="rPCon" id="rPCon1">
        	<c:forEach var="item" items="${GroomList6}" varStatus="i">
            <c:if test="${i.index <5}" >  
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}"  width="144" height="108" title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}" /></a></dt>
                <dd>
        ...
        <div class="rPCon" id="rPCon2" style="display:none;">
        	<c:forEach var="item" items="${GroomList1}" varStatus="i">
            <c:if test="${i.index <5}" >  
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}"  width="144" height="108" title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}" /></a></dt>
                <dd>
        ...
        <div class="rPCon" id="rPCon3" style="display:none;">
        	<c:forEach var="item" items="${GroomList5}" varStatus="i">
            <c:if test="${i.index <5}" >  
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}"  width="144" height="108" title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}" /></a></dt>
                <dd>
        ...
        <div class="rPCon" id="rPCon4" style="display:none;">
        	<c:forEach var="item" items="${GroomList4}" varStatus="i">
            <c:if test="${i.index <5}" >  
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}"  width="144" height="108" title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}" /></a></dt>
                <dd>
    ...
    <div class="recommendedSwitch f_l"><img src="images/index/recommendedSwitch.jpg" width="238" height="268" /></div>
</div>

<div class="goods">
	<div class="goodsArea f_l">
    	<div class="gAH3">
        	<h3>手机 • 摄影</h3>
        </div>
        <div class="gACon">
        	<c:forEach var="item" items="${ppList}" varStatus="i">  
        	<c:if test="${i.index <6}" >
        	<dl class="f_l">
           ...
           <c:if test="${i.index ==0}" >
            <span class="goodsPPT f_l"><img src="images/index/goodsPPT.jpg" width="469" height="195" /></span>
            </c:if>
        	</c:forEach>
        </div>
        <div class="gALogo">
        	<p class="f_l"><a href="###" title="apple"><img src="images/appleLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="Samsung"><img src="images/SamsungLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="casio"><img src="images/casioLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="huawei"><img src="images/huaweiLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="canon"><img src="images/canonLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="htc"><img src="images/htcLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="nikon"><img src="images/nikonLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="lenovo2"><img src="images/lenovo2Logo.jpg" /></a></p>
    	</div>
    </div>
    <div class="goodSranking f_r">
    	<div class="gSranking">
        	<div class="gSH3">
            	<span class="f_l">热销榜</span>
                <h3 class="f_l" id="ranking01">智能手机</h3>
                <h3 class="f_l" id="ranking02">微单</h3>
                <h3 class="f_l" id="ranking03">单反相机</h3>
            </div>
            <div class="gSCon" id="rankingHover01">
            	<c:forEach var="item" items="${pList}" varStatus="i">
            	<c:if test="${i.index <4}" >  
            	<dl>
                	<dt class="f_l"><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.print}" width="80" height="60" /></a></dt>
                    <dd class="f_l">
                    	<p><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}">${fn:substring(item.introduce,0,26)}</a></p>
                        <i>¥${item.price }</i>
                    </dd>  
                </dl>
                </c:if>
            ...
            <div class="gSCon" id="rankingHover02" style="display:none;">
            	<c:forEach var="item" items="${sList}" varStatus="i">
            	<c:if test="${i.index <4}" >  
            	<dl>
                	<dt class="f_l"><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.print}" width="80" height="60" /></a></dt>
                    <dd class="f_l">
            ...
            <div class="gSCon" id="rankingHover03" style="display:none;">
            	<c:forEach var="item" items="${cList}" varStatus="i">
            	<c:if test="${i.index <4}" >  
            	<dl>
                	<dt class="f_l"><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.print}" width="80" height="60" /></a></dt>
        ...
        <div class="gImg"><a href="###"><img src="images/index/gImg.jpg" width="230" height="91" /></a></div>
    </div>
</div>
<div class="goods">
	<div class="goodsArea f_l">
        ...
        <div class="gACon">
        	<c:forEach var="item" items="${ctList}" varStatus="i">  
        	<c:if test="${i.index <6}" >
        	<dl class="f_l">
            	<dt><a href="goods?id=${item.products_id}" target="_blank" title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.picture}" width="144" height="108" /></a></dt>
            	<dd>
           ...
           <c:if test="${i.index ==0}" >
            <span class="goodsPPT f_l"><img src="images/index/goodsPPT2.jpg" width="469" height="195" /></span>
            </c:if>
        	</c:forEach>
        </div>
        <div class="gALogo">
        	<p class="f_l"><a href="###" title="seagate"><img src="images/seagateLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="netgear"><img src="images/netgearLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="sennheiser"><img src="images/sennheiserLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="razer"><img src="images/razerLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="lenovo2"><img src="images/lenovo2Logo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="thinkpad"><img src="images/thinkpadLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="dell"><img src="images/dellLogo.jpg" /></a></p>
            <p class="f_l"><a href="###" title="asus"><img src="images/asusLogo.jpg" /></a></p>
    	</div>
    </div>
    <div class="goodSranking f_r">
    	<div class="gSranking">
        	<div class="gSH3">
            	<span class="f_l">热销榜</span>
                <h3 class="f_l" id="ranking11">耳机</h3>
                <h3 class="f_l" id="ranking12">笔记本</h3>
                <h3 class="f_l" id="ranking13">路由器</h3>
            </div>
            <div class="gSCon" id="rankingHover11">
            	<c:forEach var="item" items="${eList}" varStatus="i">
            	<c:if test="${i.index <4}" >  
            	<dl>
                	<dt class="f_l"><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.print}" width="80" height="60" /></a></dt>
                    <dd class="f_l">
            ...
            <div class="gSCon" id="rankingHover12" style="display:none;">
            	<c:forEach var="item" items="${nList}" varStatus="i">
            	<c:if test="${i.index <4}" >  
            	<dl>
                	<dt class="f_l"><a href="goods?id=${item.products_id}" target="_blank"  title="${item.introduce} 分类：${item.classify} 品牌：${item.brand} 型号： ${item.model}"><img src="images/share/${item.print}" width="80" height="60" /></a></dt>
            ...
            <div class="gSCon" id="rankingHover13" style="display:none;">
        ...
        <div class="gImg"><a href="###"><img src="images/index/gImg2.jpg" width="230" height="91" /></a></div>
    </div>
</div>

<div class="function">
	<span class="fun01 f_l"><a href="###"><img src="images/index/function01.gif" width="189" height="76" /></a></span>
    <span class="fun02 f_l"><a href="###"><img src="images/index/function02.gif" width="189" height="76" /></a></span>
    <span class="fun03 f_l"><a href="###"><img src="images/index/function03.gif" width="189" height="76" /></a></span>
    <span class="fun04 f_l"><a href="###"><img src="images/index/function04.gif" width="189" height="76" /></a></span>
    <span class="fun05 f_l"><a href="###"><img src="images/index/function05.gif" width="189" height="76" /></a></span>
    <span class="fun06 f_l"><a href="###"><img src="images/index/function06.gif" width="189" height="76" /></a></span>
</div>
